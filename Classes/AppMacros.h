...
static Resource iPhoneResource  =  { cocos2d::CCSizeMake(960, 640),   "Picts" };
static Resource iPhone5Resource  =  { cocos2d::CCSizeMake(1136, 640),   "Picts" };
static Resource mediumResource =  { cocos2d::CCSizeMake(1024, 768),  "Picts"   };
static Resource largeResource  =  { cocos2d::CCSizeMake(2048, 1536), "Picts-hd" };
