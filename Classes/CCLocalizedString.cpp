...
{
    ccLanguageType curLanguage = (ccLanguageType)GetGameParams->getLanguage();
    const char * fileName;
    switch (curLanguage) {
        case kLanguageEnglish:
            fileName = "localizations/Localized_en";
            break;
        case kLanguageRussian:
            fileName = "localizations/Localized_ru";
            break;
        /**
